...
public class VideoMixer {
    ...
    public void mix(String transcription, String imageDirectory, String audioFilename, String slideFilename, String outputFilename, double calculatedTime) throws Exception {
        ...
        builder.addExtraArgs("-safe", "0", "-noautorotate")
                ...
                //.setVideoFilter("scale=1280:720")
                //.setVideoFilter("scale=w=960:h=540:force_original_aspect_ratio=decrease")
                .setVideoFilter("scale=960:540:force_original_aspect_ratio=decrease,pad=960:540:(ow-iw)/2:(oh-ih)/2")
